...
if __name__ == "__main__":
    try:
        ...
        # Al correr como .exe de doble clic, Windows cierra la consola apenas
        # el proceso termina (éxito o error) — sin esto no se alcanza a leer
        # el log ni el mensaje de error.
