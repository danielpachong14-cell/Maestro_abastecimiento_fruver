...
REQUIRED_COLUMNS = {
    ...
    'tiendas': ['COD SIESA', 'NOMBRE DE LA TIENDA', 'TIPO DE PORTAFOLIO'],
...
def load_files(stock, celes, portafolio, tiendas, tiendas_item):
    """Carga y valida los 5 archivos.

    Acepta objetos UploadedFile de Streamlit o rutas/buffers compatibles con
    pandas.read_excel. Retorna un dict con 5 DataFrames o lanza ValueError con
